    ...
    ReentrancyGuard
{
    ...
    bytes32 public constant TREASURE_MARKETPLACE_ADMIN_ROLE =
    ...
    function initialize(
        ...
        require(
            ...
            "TreasureMarketplace: cannot set address(0)"
        );
    ...
    function createListing(
        ...
        require(
            ...
            "TreasureMarketplace: already listed"
        );
    ...
    function updateListing(
        ...
        require(
            listings[_nftAddress][_tokenId][_msgSender()].quantity > 0,
            "TreasureMarketplace: not listed item"
        );
        _createListingWithoutEvent(
            _nftAddress,
            _tokenId,
    ...
    function _createListingWithoutEvent(
        ...
        require(
            ...
            "TreasureMarketplace: invalid expiration time"
        );
        require(
            _pricePerItem >= MIN_PRICE,
            "TreasureMarketplace: below min price"
        );

        if (
            tokenApprovals[_nftAddress] == TokenApprovalStatus.ERC_721_APPROVED
        ) {
            IERC721 nft = IERC721(_nftAddress);
            require(
                nft.ownerOf(_tokenId) == _msgSender(),
                "TreasureMarketplace: not owning item"
            );
            require(
                nft.isApprovedForAll(_msgSender(), address(this)),
                "TreasureMarketplace: item not approved"
            );
            require(
                _quantity == 1,
                "TreasureMarketplace: cannot list multiple ERC721"
            );
        } else if (
            tokenApprovals[_nftAddress] == TokenApprovalStatus.ERC_1155_APPROVED
        ) {
            IERC1155 nft = IERC1155(_nftAddress);
            require(
                nft.balanceOf(_msgSender(), _tokenId) >= _quantity,
                "TreasureMarketplace: must hold enough nfts"
            );
            require(
                nft.isApprovedForAll(_msgSender(), address(this)),
                "TreasureMarketplace: item not approved"
    ...
    function createOrUpdateTokenBid(
        ...
        if (
            ...
            require(
                _quantity == 1,
                "TreasureMarketplace: token bid quantity 1 for ERC721"
            );
        } else if (
            tokenApprovals[_nftAddress] == TokenApprovalStatus.ERC_1155_APPROVED
        ) {
    ...
    function _createBidWithoutEvent(
        ...
        require(
            _paymentTokenForCollection == _paymentToken,
            "TreasureMarketplace: Bad payment token"
        );
    ...
    function _acceptBid(
        ...
        require(
            ...
            "TreasureMarketplace: Cannot supply own bid"
        );
        require(
            _acceptBidParams.quantity > 0,
            "TreasureMarketplace: Nothing to supply to bidder"
        );
        ...
        require(
            _bid.expirationTime >= block.timestamp,
            "TreasureMarketplace: bid expired"
        );
        require(
            _bid.pricePerItem > 0,
            "TreasureMarketplace: bid price invalid"
        );
        require(
            _bid.quantity >= _acceptBidParams.quantity,
            "TreasureMarketplace: not enough quantity"
        );
        require(
            _bid.pricePerItem == _acceptBidParams.pricePerItem,
            "TreasureMarketplace: price does not match"
        );
        ...
        if (
            tokenApprovals[_acceptBidParams.nftAddress] ==
            TokenApprovalStatus.ERC_721_APPROVED
        ) {
            require(
                _acceptBidParams.quantity == 1,
                "TreasureMarketplace: Cannot supply multiple ERC721s"
            );
            ...
            tokenApprovals[_acceptBidParams.nftAddress] ==
            TokenApprovalStatus.ERC_1155_APPROVED
        ) {
    ...
    function buyItems(BuyItemParams[] calldata _buyItemParams)
        external
        payable
        nonReentrant
        whenNotPaused
    {
        ...
        require(
            msg.value == _ethAmountRequired,
            "TreasureMarketplace: Bad ETH value"
        );
    }

    // Returns the amount of eth a user must have sent.
    function _buyItem(BuyItemParams calldata _buyItemParams)
        private
        returns (uint256)
    {
        // Validate buy order
        require(
            ...
            "TreasureMarketplace: Cannot buy your own item"
        );
        require(
            _buyItemParams.quantity > 0,
            "TreasureMarketplace: Nothing to buy"
        );
        ...
        require(
            ...
            "TreasureMarketplace: listing expired"
        );
        require(
            listedItem.pricePerItem > 0,
            "TreasureMarketplace: listing price invalid"
        );
        require(
        ...
        require(
            ...
            "TreasureMarketplace: price increased"
        );
        ...
        if (_buyItemParams.usingEth) {
            require(
                ...
                "TreasureMarketplace: ETH only used with weth collection"
            );
        }

        // Transfer NFT to buyer, also validates owner owns it, and token is approved for trading
        if (
            tokenApprovals[_buyItemParams.nftAddress] ==
            TokenApprovalStatus.ERC_721_APPROVED
        ) {
            require(
                _buyItemParams.quantity == 1,
                "TreasureMarketplace: Cannot buy multiple ERC721"
            );
    ...
    function _transferAmount(
        ...
        if (_usingEth) {
            ...
            require(
                _success,
                "TreasureMarketplace: Sending eth was not successful"
            );
        } else {
    ...
    function getPaymentTokenForCollection(address _collection)
        public
        view
        returns (address)
    {
    ...
    function _getPaymentTokenForListing(ListingOrBid memory listedItem)
        private
        view
        returns (address)
    {
    ...
    function setCollectionOwnerFee(
    ...
    ) external onlyRole(TREASURE_MARKETPLACE_ADMIN_ROLE) {
        require(
            tokenApprovals[_collectionAddress] ==
                TokenApprovalStatus.ERC_1155_APPROVED ||
                tokenApprovals[_collectionAddress] ==
                TokenApprovalStatus.ERC_721_APPROVED,
        ...
        require(
            ...
            "TreasureMarketplace: Collection fee too high"
        );
    ...
    function setTokenApprovalStatus(
        ...
        if (_status == TokenApprovalStatus.ERC_721_APPROVED) {
            require(
                ...
                "TreasureMarketplace: not an ERC721 contract"
            );
        } else if (_status == TokenApprovalStatus.ERC_1155_APPROVED) {
            require(
                IERC165(_nft).supportsInterface(INTERFACE_ID_ERC1155),
                "TreasureMarketplace: not an ERC1155 contract"
            );
        }
    ...
    function setWeth(address _wethAddress)
        external
        onlyRole(TREASURE_MARKETPLACE_ADMIN_ROLE)
    {
